...
class FakeChatCompletions:
    def __init__(self, content=None, prompt_tokens=11, completion_tokens=22):
        self.calls = []
...
def test_parse_llm_file_edit_response_rejects_empty_files():
    file_id = uuid4()
...
def test_build_file_edit_messages_includes_prompt_files_and_schema_hint():
    ...
    assert "do not include markdown fences" in system["content"].lower()
