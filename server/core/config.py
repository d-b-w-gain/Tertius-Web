...
class Settings(BaseSettings):
    ...
    import_3mf_outbox_lease_seconds: int = Field(default=30, gt=0, le=300)
    import_3mf_outbox_batch_size: int = Field(default=10, gt=0, le=100)
    import_3mf_outbox_poll_interval_seconds: float = Field(default=0.5, gt=0, le=60)
