...
import {
  type BomMetadata,
  buildAssemblyCandidateExport,
  datedAssemblyExportFilename,
  encodeAssemblyCandidateCsv,
    ...
    <div className="flex flex-col h-full bg-slate-900 p-4 overflow-hidden">
      <div className="max-w-4xl w-full mx-auto h-full flex flex-col gap-4 min-h-0">
        ...
        <div className="flex-1 flex flex-col gap-6 min-h-0">
          ...
          <FeatureTree
            isActive={activePanel === 'assembly'}
            sceneGraph={sceneGraph}
            selectedValue={highlightedNode}
            appearanceByPath={appearanceByPath}
            onActivate={() => setActivePanel('assembly')}
            onExportJson={handleExportAssemblyJson}
            onExportCsv={handleExportAssemblyCsv}
